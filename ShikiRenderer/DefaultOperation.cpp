...
void DefaultOperation::drawBox(Object& box) {
	...
	defaultShader.setMat4("model", box.model);
	defaultShader.setMat4("view", RenderState::view);
	defaultShader.setMat4("projection", RenderState::projection);
